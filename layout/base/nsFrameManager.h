...
/* provides structural modifications to the frame tree model */
 ...
 * handles structural modifications to the frame tree model, such as appending
 * and inserting a list of frames to a parent frame, or removing a child frame
 * from a parent frame.
 */
