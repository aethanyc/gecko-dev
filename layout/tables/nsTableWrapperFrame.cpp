...
LogicalSize nsTableWrapperFrame::ComputeAutoSize(
  ...
  // CreateComputeSizeFlagsForChild() can return the ShrinkWrap flag, and it is
  // fine to apply it to both the inner table and the caption because we are
  // computing their shrink-wrap sizes.
