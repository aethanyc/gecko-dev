...
nscoord nsColumnSetFrame::IntrinsicISize(const IntrinsicISizeInput input,
                                         IntrinsicISizeType aType) {
  return aType == IntrinsicISizeType::MinISize ? MinISize(input)
                                               : PrefISize(input);
}

nscoord nsColumnSetFrame::MinISize(const IntrinsicISizeInput& aInput) {
  nscoord iSize = 0;
...
nscoord nsColumnSetFrame::PrefISize(const IntrinsicISizeInput& aInput) {
