...
// A struct aggregates necessary data to compute the intrinsic inline sizes for
// a frame, used as an input for GetMinISize(), GetPrefISize(),
...
#define NS_DECLARE_FRAME_PROPERTY_SMALL_VALUE(prop, type) \
 ...
 public:
   ...
   */
  nscoord GetMinISize(const mozilla::IntrinsicISizeInput& aInput) {
   ...
   */
  virtual nscoord IntrinsicISize(const mozilla::IntrinsicISizeInput& aInput,
 ...
 protected:
   ...
   */
  nscoord ShrinkISizeToFit(const mozilla::IntrinsicISizeInput& aInput,
                           nscoord aISizeInCB,
                           mozilla::ComputeSizeFlags aFlags);
