...
#define NS_DECLARE_FRAME_PROPERTY_SMALL_VALUE(prop, type) \
  ...
  //
  // Note: this method only checks 'break-before' property on this frame, and it
  // doesn't handle forced break value propagation from its first child. Callers
  // should handle the propagation in reflow.
  ...
  //
  // Note: this method only checks 'break-after' property on this frame, and it
  // doesn't handle forced break value propagation from its last child. Callers
  // should handle the propagation in reflow.
