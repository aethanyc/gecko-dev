...
nscoord nsBlockFrame::IntrinsicISize(const IntrinsicISizeInput& aInput,
...
/* virtual */
nscoord nsBlockFrame::MinISize(const IntrinsicISizeInput& aInput) {
...
/* virtual */
nscoord nsBlockFrame::PrefISize(const IntrinsicISizeInput& aInput) {
  if (Maybe<nscoord> containISize = ContainIntrinsicISize()) {
    return *containISize;
  }
