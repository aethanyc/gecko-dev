...
ScrollReflowInput::ScrollReflowInput(nsHTMLScrollFrame* aFrame,
  ...
  if (scrollbarWidth == StyleScrollbarWidth::None) {
    ...
    const nscoord scrollbarSize = aFrame->GetNonOverlayScrollbarWidth(
...
nsMargin nsHTMLScrollFrame::GetDesiredScrollbarSizes() const {
  ...
  auto size = GetNonOverlayScrollbarWidth(pc, scrollbarWidth);
...
nscoord nsHTMLScrollFrame::GetNonOverlayScrollbarWidth(
    const nsPresContext* aPc, StyleScrollbarWidth aScrollbarWidth) const {
...
void nsHTMLScrollFrame::LayoutScrollbars(ScrollReflowInput& aState,
  ...
  if (mResizerBox) {
    ...
    auto scrollbarWidth = nsLayoutUtils::StyleForScrollbar(this)
                              ...
                              ->ScrollbarWidth();
    const nscoord scrollbarSize =
        GetNonOverlayScrollbarWidth(pc, scrollbarWidth);
