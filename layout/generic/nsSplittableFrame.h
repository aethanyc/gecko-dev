...
class nsSplittableFrame : public nsIFrame {
 ...
 protected:
  ...
  // Return the first-continuation for this frame if it is the
  // first-continuation in the chain or if it has a cached first-continuation.
  // Otherwise, return nullptr.
  nsIFrame* GetFirstContinuationIfCached() const;

  // Return the first-in-flow for this frame if it is the first-in-flow in the
  // chain or if it has a cached first-in-flow. Otherwise, return nullptr.
